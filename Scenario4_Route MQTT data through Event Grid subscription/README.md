...
Follow the instructions in the [Prerequisites](#prerequisites) to test this scenarios. Configure the resources using the following instructions. Afterwards, follow the instructions to test the scenario and observe the data flow.
...
- Set EventGrid Data Sender role to your user ID
	...
	- In the "Members" tab, "+Select members", then type your AD User name in the search bar (e.g. user@contoso.com).
