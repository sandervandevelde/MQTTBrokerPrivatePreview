...
az eventgrid topic create -g ${rg_name} --name <topic name> -l eastus2euap --input-schema cloudeventschemav1_0
...
3. In a terminal window, set up the following variable: `export gw_url="<namespace name>.eastus2euap-1.ts.eventgrid.azure.net"` and run the sample script through the following command: `python ./publish.py`
