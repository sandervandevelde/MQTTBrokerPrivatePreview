...
###### MQTT Properties
- ${mqtt.message.userProperties.x} or alternatively ${mqtt.message.userProperties['x']}: user properties in the MQTTv5 publish request, where x is the user property key name 
  - Type: string
